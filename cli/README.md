...
- Index surface가 있으면 assessment가 완전한 applicable `physical_design` candidate를 비교에 포함한다. 이 candidate는 자동 선택되지 않으며, 비교 후 selected option은 어떤 applicable candidate도 될 수 있다.
